package advent.of.code.a2018.day2;
...
public class Mainday2 {
    ...
    private static long getReponseQuestion1() {
        Map<Long, Long> count = LectureFichiersUtils.getData("2018/fichier2.txt")
    ...
    private static String getReponseQuestion2() {
      List<String> data = LectureFichiersUtils.getData("2018/fichier2.txt").collect(Collectors.toList());
      for(String a :  data) {
        for(String b :  data)  {
          if(nbDiff(a,b)==1 ) {
