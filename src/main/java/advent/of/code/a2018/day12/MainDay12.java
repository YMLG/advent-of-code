package advent.of.code.a2018.day12;
...
public class MainDay12 {
  ...
  public static void main(String[] args) {
    String input = LectureFichiersUtils.getData("2018/fichier12.txt").findFirst().orElse("").replaceAll("initial state: ", "");
    Map<String, Boolean> regles = LectureFichiersUtils.getData("2018/fichier12.txt")
